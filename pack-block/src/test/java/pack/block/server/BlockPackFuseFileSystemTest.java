...
public class BlockPackFuseFileSystemTest {
  ...
  // LoggerFactory.getLogger(BlockPackFuseFileSystemTest.class);
  //
  ...
  // BlockPackFuseFileSystemTest.class.getName());
  ...
  // TEST_BLOCK_PACK_FUSE_FILE_SYSTEM);
  ...
  // HdfsSnapshotUtil.createSnapshot(fileSystem, volumePath,
  // HdfsSnapshotUtil.getMountSnapshotName(strategy));
  ...
  // .build();
  //
  // BlockPackFuseConfigInternal fuseConfig =
  // BlockPackFuseConfigInternal.builder()
  ...
  // PackCompactorServer(compactorDir, fileSystem.getConf(), pathList,
  // zk)) {
