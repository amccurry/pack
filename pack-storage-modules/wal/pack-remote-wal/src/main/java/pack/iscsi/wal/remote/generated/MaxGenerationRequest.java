...
public class MaxGenerationRequest implements org.apache.thrift.TBase<MaxGenerationRequest, MaxGenerationRequest._Fields>, java.io.Serializable, Cloneable, Comparable<MaxGenerationRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MaxGenerationRequest");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new MaxGenerationRequestStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new MaxGenerationRequestTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MaxGenerationRequest.class, metaDataMap);
  }

  public MaxGenerationRequest() {
  }
   ...
   */
  public MaxGenerationRequest(MaxGenerationRequest other) {
    __isset_bitfield = other.__isset_bitfield;
    this.volumeId = other.volumeId;
    this.blockId = other.blockId;
  }

  public MaxGenerationRequest deepCopy() {
    return new MaxGenerationRequest(this);
  }
  ...
  public MaxGenerationRequest setVolumeId(long volumeId) {
    this.volumeId = volumeId;
    setVolumeIdIsSet(true);
    return this;
  }
  ...
  public MaxGenerationRequest setBlockId(long blockId) {
    this.blockId = blockId;
    setBlockIdIsSet(true);
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof MaxGenerationRequest)
      return this.equals((MaxGenerationRequest)that);
    return false;
  }

  public boolean equals(MaxGenerationRequest that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(MaxGenerationRequest other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("MaxGenerationRequest(");
    boolean first = true;
  ...
  private static class MaxGenerationRequestStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public MaxGenerationRequestStandardScheme getScheme() {
      return new MaxGenerationRequestStandardScheme();
    }
  }

  private static class MaxGenerationRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<MaxGenerationRequest> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MaxGenerationRequest struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MaxGenerationRequest struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class MaxGenerationRequestTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public MaxGenerationRequestTupleScheme getScheme() {
      return new MaxGenerationRequestTupleScheme();
    }
  }

  private static class MaxGenerationRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<MaxGenerationRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MaxGenerationRequest struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MaxGenerationRequest struct) throws org.apache.thrift.TException {
