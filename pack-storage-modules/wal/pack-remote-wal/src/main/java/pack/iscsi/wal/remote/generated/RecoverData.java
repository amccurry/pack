...
public class RecoverData implements org.apache.thrift.TBase<RecoverData, RecoverData._Fields>, java.io.Serializable, Cloneable, Comparable<RecoverData> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RecoverData");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new RecoverDataStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new RecoverDataTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RecoverData.class, metaDataMap);
  }
   ...
   */
  public RecoverData(RecoverData other) {
  ...
  public RecoverData deepCopy() {
    return new RecoverData(this);
  }
  ...
  public RecoverData setVolumeId(long volumeId) {
    this.volumeId = volumeId;
    setVolumeIdIsSet(true);
    return this;
  }
  ...
  public RecoverData setBlockId(long blockId) {
    this.blockId = blockId;
    setBlockIdIsSet(true);
    return this;
  }
  ...
  public RecoverData setGeneration(long generation) {
    this.generation = generation;
    setGenerationIsSet(true);
    return this;
  }
  ...
  public RecoverData setPosition(long position) {
    this.position = position;
    setPositionIsSet(true);
    return this;
  }
  ...
  public RecoverData setData(byte[] data) {
    this.data = data == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(data.clone());
    return this;
  }

  public RecoverData setData(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer data) {
    this.data = org.apache.thrift.TBaseHelper.copyBinary(data);
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof RecoverData)
      return this.equals((RecoverData)that);
    return false;
  }

  public boolean equals(RecoverData that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(RecoverData other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("RecoverData(");
    boolean first = true;
  ...
  private static class RecoverDataStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public RecoverDataStandardScheme getScheme() {
      return new RecoverDataStandardScheme();
    }
  }

  private static class RecoverDataStandardScheme extends org.apache.thrift.scheme.StandardScheme<RecoverData> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, RecoverData struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RecoverData struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class RecoverDataTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public RecoverDataTupleScheme getScheme() {
      return new RecoverDataTupleScheme();
    }
  }

  private static class RecoverDataTupleScheme extends org.apache.thrift.scheme.TupleScheme<RecoverData> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RecoverData struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RecoverData struct) throws org.apache.thrift.TException {
