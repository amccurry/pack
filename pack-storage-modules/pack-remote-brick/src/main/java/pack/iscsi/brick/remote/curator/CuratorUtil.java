...
public class CuratorUtil {
  ...
  private static final String WAL_HOSTS = "/brick/hosts";
  ...
  public static List<PackBrickHostEntry> getRegisteredServers(CuratorFramework curatorFramework, String zkPrefix)
      throws Exception {
    if (curatorFramework == null) {
    ...
    List<PackBrickHostEntry> entries = new ArrayList<>();
    for (String s : list) {
      List<String> parts = PORT_SPLITTER.splitToList(s);
      entries.add(PackBrickHostEntry.builder()
