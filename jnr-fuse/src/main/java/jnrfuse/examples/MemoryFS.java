...
public class MemoryFS extends FuseStubFS {
  ...
  private class MemoryFile extends MemoryPath {
    ...
    private MemoryFile(String name, int length) {
      super(name);
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      memfs.mount(Paths.get("./mnt"), true, true, opts);
    } finally {
      memfs.umount();
    }
  }
  ...
  public MemoryFS() {
    ...
    rootDirectory.add(new MemoryFile("data", 100 * 1024 * 1024));
  }
