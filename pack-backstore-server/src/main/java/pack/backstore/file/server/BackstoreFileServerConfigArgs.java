...
import pack.backstore.file.server.BackstoreFileServerConfig.BackstoreFileServerConfigBuilder;

public class BackstoreFileServerConfigArgs {

  private static final String STORE_DIR_LONG = "storedir";
  private static final String STORE_DIR_SHORT = "d";

  public static BackstoreFileServerConfig create(String[] args) throws ParseException, IOException {
    ...
    BackstoreFileServerConfigBuilder builder = BackstoreFileServerConfig.builder();
