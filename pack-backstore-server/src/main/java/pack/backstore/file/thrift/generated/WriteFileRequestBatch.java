...
public class WriteFileRequestBatch implements org.apache.thrift.TBase<WriteFileRequestBatch, WriteFileRequestBatch._Fields>, java.io.Serializable, Cloneable, Comparable<WriteFileRequestBatch> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<WriteFileRequest> writeRequests; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.WRITE_REQUESTS, new org.apache.thrift.meta_data.FieldMetaData("writeRequests", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT            , "WriteFileRequest"))));
  ...
  public WriteFileRequestBatch(
    ...
    java.util.List<WriteFileRequest> writeRequests)
  {
    this();
  ...
  public WriteFileRequestBatch(WriteFileRequestBatch other) {
    ...
    if (other.isSetWriteRequests()) {
      java.util.List<WriteFileRequest> __this__writeRequests = new java.util.ArrayList<WriteFileRequest>(other.writeRequests.size());
      for (WriteFileRequest other_element : other.writeRequests) {
        __this__writeRequests.add(new WriteFileRequest(other_element));
      }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<WriteFileRequest> getWriteRequestsIterator() {
    return (this.writeRequests == null) ? null : this.writeRequests.iterator();
  }

  public void addToWriteRequests(WriteFileRequest elem) {
    if (this.writeRequests == null) {
      this.writeRequests = new java.util.ArrayList<WriteFileRequest>();
    }
    this.writeRequests.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<WriteFileRequest> getWriteRequests() {
    return this.writeRequests;
  }

  public WriteFileRequestBatch setWriteRequests(@org.apache.thrift.annotation.Nullable java.util.List<WriteFileRequest> writeRequests) {
    this.writeRequests = writeRequests;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case WRITE_REQUESTS:
      if (value == null) {
        ...
        setWriteRequests((java.util.List<WriteFileRequest>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.writeRequests = new java.util.ArrayList<WriteFileRequest>(_list16.size);
                @org.apache.thrift.annotation.Nullable WriteFileRequest _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = new WriteFileRequest();
                  _elem17.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WriteFileRequestBatch struct) throws org.apache.thrift.TException {
      ...
      if (struct.writeRequests != null) {
        oprot.writeFieldBegin(WRITE_REQUESTS_FIELD_DESC);
        {
          ...
          for (WriteFileRequest _iter19 : struct.writeRequests)
          {
            _iter19.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetWriteRequests()) {
        {
          ...
          for (WriteFileRequest _iter20 : struct.writeRequests)
          {
            _iter20.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.writeRequests = new java.util.ArrayList<WriteFileRequest>(_list21.size);
          @org.apache.thrift.annotation.Nullable WriteFileRequest _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = new WriteFileRequest();
            _elem22.read(iprot);
