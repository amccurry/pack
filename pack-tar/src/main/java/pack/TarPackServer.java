...
public class TarPackServer extends PackServer {
  ...
  public static void main(String[] args) throws Exception {
    ...
    TarPackServer packServer = new TarPackServer(isGlobal(), PORT, LOOP_BACK_ADDR, LOOP_BACK_ADDR_CIDR, localFile,
        remotePath, ugi);
    packServer.writeDockerPluginFile();
  ...
  public TarPackServer(boolean global, int port, String loopBackAddr, String loopBackAddrCidr, File localFile,
      Path remotePath, UserGroupInformation ugi) {
    super(global, port, loopBackAddr, loopBackAddrCidr);
