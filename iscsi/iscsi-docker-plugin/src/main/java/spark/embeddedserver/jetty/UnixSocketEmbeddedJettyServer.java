...
public class UnixSocketEmbeddedJettyServer implements EmbeddedServer {
  ...
  public UnixSocketEmbeddedJettyServer(JettyServerFactory serverFactory, Handler handler) {
  ...
  public int ignite(String host, int port, SslStores sslStores, int maxThreads, int minThreads,
    ...
    connector.setUnixSocket(host);
    server = connector.getServer();
    server.setConnectors(new Connector[] { connector });

    ServletContextHandler webSocketServletContextHandler = WebSocketServletContextHandlerFactory.create(
        webSocketHandlers, webSocketIdleTimeoutMillis);
