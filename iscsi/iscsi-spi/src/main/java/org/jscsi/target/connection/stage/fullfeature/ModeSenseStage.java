...
public final class ModeSenseStage extends TargetFullFeatureStage {
  ...
  @Override
  public void execute(final ProtocolDataUnit pdu)
    ...
    if (modePages != null) {
      ...
      builder.setLogicalBlockDescriptors(new ShortLogicalBlockDescriptor(storageModule.getSizeInBlocks(), // numberOfLogicalBlocks
          storageModule.getBlockSize()));// logicalBlockLength
      ...
      /*
       * The initiator has requested a mode sense page which the jSCSI Target
       * cannot provide. This could be answered with an Illegal field in CDB
       * message but, there is no good way to identify the exact field at fault.
       */
