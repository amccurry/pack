...
public final class ReadCapacityStage extends TargetFullFeatureStage {
  ...
  public void execute(ProtocolDataUnit pdu)
    ...
    /*
     * Everything is fine, carry on. The PMI bit of the command descriptor block
     * is ignored, since there is no way to know if
     * "substantial vendor specific delay in data transfer may be encountered"
     * after the address in the LOGICAL BLOCK ADDRESS field. Therefore we always
     * try to return the whole length of the storage medium.
     */
