...
public class EmbeddedKafkaCluster {
  ...
  public void startup() {
    for (int i = 0; i < ports.size(); i++) {
      ...
      File logDir = EmbeddedTestUtils.constructTempDir("kafka-local");
  ...
  private KafkaServer startBroker(Properties props) {
    Seq<KafkaMetricsReporter> seq = scala.collection.JavaConversions.asScalaBuffer(Arrays.asList());
