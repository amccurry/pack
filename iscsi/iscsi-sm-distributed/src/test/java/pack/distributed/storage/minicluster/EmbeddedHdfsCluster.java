...
public class EmbeddedHdfsCluster {

  private static Logger LOGGER = LoggerFactory.getLogger(EmbeddedHdfsCluster.class);
  private Configuration conf;
  private String path;
  private MiniDFSCluster _cluster;

  public EmbeddedHdfsCluster() {
    this(new Configuration());
  }

  public EmbeddedHdfsCluster(Configuration conf) {
    this.conf = conf;
    this.path = "./target/embeddedhdfs";
  }

  public FileSystem getFileSystem() throws IOException {
    return _cluster == null ? null : _cluster.getFileSystem();
  }
