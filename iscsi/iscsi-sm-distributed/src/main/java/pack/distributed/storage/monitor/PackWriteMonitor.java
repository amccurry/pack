...
public class PackWriteMonitor {
  ...
  public PackWriteMonitor(String name, PackHdfsReader hdfsReader, PackWalCacheManager walCacheManager,
  ...
  public void waitForDataIfNeeded(PackTracer tracer, List<ReadRequest> requests,
  ...
  private void waitForWallToSync(PackTracer tracer, long now) throws IOException {
