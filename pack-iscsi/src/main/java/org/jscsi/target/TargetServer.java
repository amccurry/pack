...
import pack.iscsi.TargetManager;
...
public final class TargetServer implements Callable<Void> {
  ...
  private TargetManager iscsiTargetManager;
  ...
  public TargetServer(InetAddress targetAddress, int targetPort, TargetManager iscsiTargetManager) throws IOException {
